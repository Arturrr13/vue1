<template>
    <section class="privacy-policy">
        ...
        <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to UMF.</p>
        </li>
        <li>
        ...
        <li>
        <p><strong>Website</strong> refers to UMF, accessible from <router-link title="home" rel="nofollow" to="/">UMF.com</router-link></p>
        </li>
        <li>
